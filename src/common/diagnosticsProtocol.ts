...
export const webviewDiagnosticNames = [
	...
	"comment.reattach.started",
	"comment.reattach.completed",
	"comment.reattach.failed",
	"comment.followUp.started",
	"comment.followUp.completed",
	"comment.followUp.failed",
	"settings.open.started",
	"settings.open.completed",
